...
public class Launcher3DDeveMode implements ApplicationListener {
...
//    }
     ...
     * @throws Exception
     */
    public Launcher3DDeveMode() throws Exception {
...
//		System.exit(0);
    ...
    public static void main(final String[] args) throws Exception {
        Launcher3DDeveMode desktopLauncher3D = new Launcher3DDeveMode();
