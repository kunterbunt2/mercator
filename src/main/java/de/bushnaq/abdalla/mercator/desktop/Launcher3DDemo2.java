 ...
 * @author kunterbunt
 */
public class Launcher3DDemo2 implements ApplicationListener {
    ...
    LaunchMode            launchMode     = LaunchMode.demo2;
...
//		config.setMaximized(true);
    ...
    public static void main(final String[] args) throws Exception {
        Launcher3DDemo2 desktopLauncher3D = new Launcher3DDemo2();
