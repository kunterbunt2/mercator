...
import com.abdalla.bushnaq.mercator.universe.sim.SimStatus;
...
public class TradingStabilityTest {
	...
	public void testTrading() throws Exception {
		...
		for (int i = 0; i < universeList.length; i++) {
			...
			universeList[i].create(i, UNIVERSE_SIZE, 100L * TimeUnit.TICKS_PER_DAY);
		}
